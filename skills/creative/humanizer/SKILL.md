...
version: 2.5.1
author: Siqi Chen (@blader, https://github.com/blader/humanizer), ported by Ion Agent
license: MIT
...
Detect and eliminate hallmarks of AI-generated text so writing reads naturally and human. Built on Wikipedia's "Signs of AI writing" guide (maintained by WikiProject AI Cleanup), distilled from observations of thousands of AI-generated text instances.

**Key insight:** LLMs rely on statistical algorithms to predict what comes next. The output gravitates toward the most statistically probable completion, which is precisely how the telltale patterns below become baked in.
...
Also apply this skill to **your own** output when writing user-facing prose — release notes, PR descriptions, documentation, long-form explanations, summaries. Ion's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in Ion
