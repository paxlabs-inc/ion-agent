...
Built for [Ion Agent](https://github.com/NousResearch/ion-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/ion-agent/skills/creative/ascii-video`](https://github.com/NousResearch/ion-agent/tree/main/skills/creative/ascii-video) via PR.
