...
A comprehensive guide to Meta AI's Segment Anything Model for zero-shot image segmentation.

## When to use SAM

**Use SAM when:**
- You need to segment any object in images without task-specific training
- You're building interactive annotation tools with point/box prompts
- You're generating training data for other vision models
- You need zero-shot transfer to new image domains
- You're building object detection/segmentation pipelines
- You're processing medical, satellite, or domain-specific images
